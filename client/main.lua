...
function OpenCloakroomMenu()
	...
	elseif grade == 'agent' then -- Agent
		table.insert(elements, {label = 'Noodhulp Kort', value = 'nh_kort'})
		table.insert(elements, {label = 'Noodhulp Lang', value = 'nh_lang'})
		table.insert(elements, {label = 'Motor', value = 'motor'})
		table.insert(elements, {label = 'Ongemarkeerd', value = 'unmarked'})
	elseif grade == 'hoofdagent' then -- Hoofdagent
		table.insert(elements, {label = 'Noodhulp Kort', value = 'nh_kort'})
		table.insert(elements, {label = 'Noodhulp Lang', value = 'nh_lang'})
		table.insert(elements, {label = 'Verkeerspolitie Kort', value = 'vp_kort'})
		table.insert(elements, {label = 'Verkeerspolitie Lang', value = 'vp_lang'})
		table.insert(elements, {label = 'Motor', value = 'motor'})
		table.insert(elements, {label = 'Ongemarkeerd', value = 'unmarked'})
	...
	elseif grade == 'inspecteur' then -- Inspecteur
		...
		table.insert(elements, {label = 'Motor', value = 'motor'})
		table.insert(elements, {label = 'Ongemarkeerd', value = 'unmarked'})
		table.insert(elements, {label = 'IBT', value = 'ibt'})
